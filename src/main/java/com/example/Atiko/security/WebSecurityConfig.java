package com.example.Atiko.security;
...
import com.example.Atiko.security.jwt.AuthTokenFilter;
...
public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
    http
        ...
        .authenticationProvider(authenticationProvider())  // Set up custom authentication provider
        .formLogin(form -> form
            .loginPage("/login")  // Set the login page for form login
            .permitAll()
        )
